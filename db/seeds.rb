...
User.find_or_create_by_email!(:email => 'herlangga@pushjaw.com', :first_name => "Heralngga", :last_name => "pushjaw", :telephone => "0987654321", :address => "mig 1", :role_id => 1, :password => '12345678', :birth_date => "1993-04-09", :position => "programmer", :account_number => "12345", :bank_name => "BCA", :account_branch_name => "Cianjur", :account_name => "nama akun")
